...
<div class="content">
  ...
  <div class="card">
      <div class="card-header">
          <a href="{{ route('permissions.index') }}" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md">List Permissions</a>
      </div>
    </div>
    <div class="card">
      <div class="card-body">
          <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
              <form method="POST" action="{{ route('permissions.store') }}">
                  @csrf
                  <div class="row mb-3">
                      <label class="col-form-label col-lg-3">Permission Name</label>
                      <div class="col-lg-9">
