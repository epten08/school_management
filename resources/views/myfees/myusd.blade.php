    ...
    <div class="card">
        <div class="card-header d-flex align-items-center py-0">
            ...
            <div class="d-inline-flex ms-auto">
                ...
                <a type="button" href="{{route('usdstatement')}}" class="btn btn-light ms-3"><i class="ph-printer me-2"></i> Print</a>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-4">
                        <div class="d-inline-flex align-items-center mt-2 mb-3">
                            ...
                            <h4 class="d-none d-sm-inline-block text-body mb-0 ms-2">{{$profile->name}}</h4>
                        </div>
                         <ul class="list list-unstyled mt-2 mb-0">
                            <li>{{$profile->physical_address}}</li>
                            <li>{{$profile->phone}}</li>
                            <li>{{$profile->email_address}}</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="text-sm-end mb-4">
                        <h4 class="text-primary mb-2 mt-lg-2">Fees Statement USD</h4>
                        <ul class="list list-unstyled mb-0">
                            <li>Date Generated: <span class="fw-semibold">{{\Carbon\Carbon::now()->format('l jS \\of F Y')}}</span></li>
            ...
            <table class="table table-lg">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if ($myfee['fForeignDebit'] == 0)
                        <td> </td>
                        @else
                        <td>{{$myfee['fForeignDebit']}}</td>
                        @endif
                        @if ($myfee['fCForeignredit'] == 0)
                        <td> </td>
                        @else
                        <td>{{$myfee['fForeignCredit']}}</td>
                        @endif
...
<div class="navbar navbar-sm navbar-footer border-top">
    <div class="container-fluid">
        <span>&copy; 2023 <a href="https://themeforest.net/item/limitless-responsive-web-application-kit/13080328">Olimem Enterprise Solutions</a></span>
{{-- 
        <ul class="nav">
            <li class="nav-item">
